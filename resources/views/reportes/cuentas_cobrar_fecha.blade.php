...
<head>
    <meta charset="UTF-8">
    <title>CuentasCobrarCliente</title>
    <style type="text/css">
        * {
...
<body>
    ...
    <div class="encabezado">
        ...
        <h4 class="texto">CUENTAS POR COBRAR A LA FECHA</h4>
    ...
    <table border="1">
        ...
        <tbody>
            @php
                $total = 0;
            @endphp
            @foreach ($cuentas_cobrar as $value)
                <tr>
                    <td>{{ $value->cliente->nombre }}</td>
                    <td class="centreado">{{ $value->saldo }}</td>
                </tr>
                @php
                    $total += $value->saldo;
                @endphp
            @endforeach
            <tr>
                <td class="derecha bold">TOTAL</td>
                <td class="centreado bold">{{ $total }} </td>
            </tr>
        </tbody>
    </table>
</body>
