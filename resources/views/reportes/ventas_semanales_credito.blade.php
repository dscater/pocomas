...
<head>
    <meta charset="UTF-8">
    <title>VentasSemanalCredito</title>
    <style type="text/css">
        * {
...
<body>
    ...
    <div class="encabezado">
        ...
        <h4 class="texto">VENTAS SEMANALES AL CRÉDITO</h4>
        ...
        <tbody>
            ...
            @foreach ($clientes as $cliente)
                <tr>
                    ...
                    @endphp
                    @for ($i = 1; $i <= $total_semanas; $i++)
                        <td class="centreado">{{ $ventas_creditos_semanal[$cliente->id][$i]['monto_total'] }}</td>
                        @php
                            $monto_total_total += (float) $ventas_creditos_semanal[$cliente->id][$i]['monto_total'];
                        @endphp
                    @endfor
