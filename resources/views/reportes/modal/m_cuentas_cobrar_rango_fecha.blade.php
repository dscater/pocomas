<div class="modal fade" id="m_cuentas_cobrar_rango_fecha">
    <div class="modal-dialog">
        {!! Form::open([
            'route' => 'reportes.cuentas_cobrar_rango_fecha',
            'method' => 'get',
            'target' => '_blank',
        ]) !!}
        <div class="modal-content  bg-sucess">
            <div class="modal-header">
                <h4 class="modal-title">Cuentas por cobrar a la fecha (Rango de fechas)</h4>
