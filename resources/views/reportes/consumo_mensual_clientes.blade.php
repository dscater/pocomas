...
<body>
    ...
    <div class="encabezado">
        ...
        <h4 class="texto">CONSUMO MENSUAL POR CLIENTE</h4>
        ...
        <tbody>
            ...
            @foreach ($clientes as $cliente)
                <tr>
                    ...
                    @endphp
                    @foreach ($meses as $value)
                        <td class="centreado">{{ $consumo_clientes[$cliente->id][$value]['cantidad'] }}</td>
                        @php
                            $cantidad_total += (float) $consumo_clientes[$cliente->id][$value]['cantidad'];
                        @endphp
                    @endforeach
