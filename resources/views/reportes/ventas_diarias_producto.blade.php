...
<head>
    <meta charset="UTF-8">
    <title>VentasDiariasProducto</title>
    <style type="text/css">
        * {
        ...
        <tbody>
            ...
            @foreach ($productos as $producto)
                <tr>
                    ...
                    <td class="centreado">{{ $ventas_producto[$producto->id]['cantidad'] }}</td>
                    <td class="centreado">{{ $ventas_producto[$producto->id]['precio'] }}</td>
                    <td class="centreado">{{ $ventas_producto[$producto->id]['importe'] }}</td>
                    @php
                        $importe_total += (float) $ventas_producto[$producto->id]['importe'];
                    @endphp
                </tr>
            @endforeach
            <tr>
                <td colspan="3" class="derecha bold">IMPORTE TOTAL</td>
                <td class="centreado bold">{{ number_format($importe_total, 2) }} </td>
            </tr>
        </tbody>
    </table>
</body>
