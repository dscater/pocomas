...
<head>
    <meta charset="UTF-8">
    <title>VentasDiariasCredito</title>
    <style type="text/css">
        * {
...
<body>
    ...
    <div class="encabezado">
        ...
        <h4 class="texto">VENTAS DIARIAS AL CRÉDITO</h4>
            ...
            @foreach ($clientes as $cliente)
                <tr>
                    ...
                    @foreach ($array_dias as $key => $dia)
                        <td class="centreado">{{ $ventas_credito[$cliente->id][$key] }}</td>
                        @php
                            $total += (float) $ventas_credito[$cliente->id][$key];
                        @endphp
                    @endforeach
