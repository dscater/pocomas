...
<body>
    ...
    <div class="encabezado">
        ...
        <h4 class="texto">DESCUENTO EN VENTAS</h4>
    ...
    <table border="1">
        ...
        <tbody>
            @php
                $total_importe = 0;
            @endphp
            @foreach ($descuento_ventas as $value)
                <tr>
                    <td>{{ $value->fecha }}</td>
                    <td>{{ $value->cliente }}</td>
                ...
                @php
                    $total_importe += (float) $value->descuento;
                @endphp
            @endforeach
            <tr>
                <td class="bold derecha" colspan="2">TOTAL</td>
                <td class="bold centreado">{{ number_format($total_importe, 2) }}</td>
            </tr>
        </tbody>
    </table>
</body>
