            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('productos.create')}}" class="btn btn-info"><i class="fa fa-plus"></i> Nuevo</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example2" class="table data-table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="{{$limite}}">
                                    <td>{{$cont++}}</td>
                                    <td class="text-center"><img src="{{asset('imgs/productos/'.$producto->foto)}}" alt="Imagen" style="height:50px;width:50px;"></td>
