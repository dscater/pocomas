            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        {{ Form::model($ingreso_caja, ['route' => ['ingreso_cajas.update', $ingreso_caja->id], 'method' => 'put']) }}
                        <div class="card-body">
                            @include('ingreso_cajas.form.form')
                            <button type="submit" class="btn btn-info" id="btnRegistrar"><i class="fa fa-update"></i>
                                ACTUALIZAR</button>
                        </div>
                        {{ Form::close() }}
                        <!-- /.card-body -->
