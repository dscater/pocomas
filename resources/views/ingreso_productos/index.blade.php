                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('ingreso_productos.create') }}" class="btn btn-info"><i
                                        ...
                                        <tr>
                                            ...
                                            <td class="btns-opciones">
                                                @if (Auth::user()->tipo == 'ADMINISTRADOR')
                                                    <a href="{{ route('ingreso_productos.edit', $ingreso_producto->id) }}"
                                                        class="modificar"><i class="fa fa-edit" data-toggle="tooltip"
                                                            data-placement="left" title="Modificar"></i></a>

                                                    <a href="#"
                                                        data-url="{{ route('ingreso_productos.destroy', $ingreso_producto->id) }}"
