<div class="row">
    <div class="col-md-2">
        <div class="form-group">
            <label>Lote*</label>
            {{ Form::select('ingreso_producto_id', $array_lotes, isset($merma) ? $merma->detalle_ingreso->ingreso_producto->id : null, ['class' => 'form-control', 'id' => 'ingreso_producto_id']) }}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label>Producto*</label>
            {{ Form::select('producto_id', [], null, ['class' => 'form-control', 'id' => 'producto_id', 'required']) }}
        </div>
    </div>
    <div class="col-md-2">
        <div class="form-group">
