                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('mermas.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> Nuevo</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="btns-opciones">
                                                ...
                                                @if (Auth::user()->tipo == 'ADMINISTRADOR')
                                                    <a href="#" data-url="{{ route('mermas.destroy', $merma->id) }}"
...
@section('scripts')
    <script>
        ...
        $(document).on('click', 'table tbody tr td.btns-opciones a.eliminar', function(e) {
            e.preventDefault();
            let merma = $(this).parents('tr').children('td').eq(1).text();
            $('#mensajeEliminar').html(`¿Está seguro(a) de eliminar el registro <b>${merma}</b>?`);
